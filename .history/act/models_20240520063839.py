...
class RequirementRelationship(models.Model):
    from_requirement = models.ForeignKey(Requirement, related_name='from_requirements', on_delete=models.CASCADE,verbose_name='父需求')
    to_requirement = models.ForeignKey(Requirement, related_name='to_requirements', on_delete=models.CASCADE,verbose_name='子需求')
