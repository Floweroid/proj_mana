...
To display the status choices in English, you can simply update the second value in each tuple of STATUS_CHOICES to the corresponding English translation. Here's how you can modify your Todo model to achieve this:
