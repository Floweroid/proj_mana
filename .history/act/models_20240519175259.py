...
class Requirement(models.Model):
    ...
    parents = models.ManyToManyField('self', symmetrical=False, blank=True, related_name='children', verbose_name='父需求')
    children = models.ManyToManyField('self', symmetrical=False, blank=True, related_name='parents', verbose_name='父需求')
