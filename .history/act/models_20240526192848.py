...
class TodoRelationship(models.Model):
    from_Todo = models.ForeignKey(Todo, related_name='from_Todos', on_delete=models.CASCADE,verbose_name='origin')
    to_Todo = models.ForeignKey(Todo, related_name='to_Todos', on_delete=models.CASCADE,verbose_name='subtodos')
...
class Person(models.Model):
    ...
    description = models.TextField(verbose_name='Description', null=True, blank=True)
    birthdate = models.DateField(verbose_name='Birthdate', null=True, blank=True)  # Add the birthdate field
