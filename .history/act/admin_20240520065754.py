...
# Custom datetime format function
    def custom_datetime_format(self, obj):
        return obj.created_at.strftime("%H:%M:%S %m.%d.%y") if obj.created_at else ''

    # Register the custom datetime format method as a list_display item
    custom_datetime_format.short_description = 'Created At'
    custom_datetime_format.admin_order_field = 'created_at'
