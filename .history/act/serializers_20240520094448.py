...
class RequirementSerializer(serializers.ModelSerializer):
    children = serializers.PrimaryKeyRelatedField(queryset=Requirement.objects.all(), many=True, required=False)

    class Meta:
        model = Requirement
        fields = ['id', 'name', 'status', 'description', 'priority', 'created_at', 'updated_at', 'start_time', 'end_time', 'children']
