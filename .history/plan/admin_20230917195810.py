...
class TaskAdmin(admin.ModelAdmin):
    list_display = ["start_time", "status", "title", "description", "end_time","get_members_display","create_time"]
    fieldsets = [
        (None, {"fields": ["status","title", "description"]}),
        ("Date&Time information", {"fields": ["start_time","end_time","create_time"], "classes": ["collapse"]}),
    ]
